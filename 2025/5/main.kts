...
data class Range(val start: Long, val end: Long) {
    fun contains(l: Long): Boolean = start <= l && l <= end
    fun count(): Long = end - (start - 1)
    fun isWithin(other: Range): Boolean = this.contains(other.start) && this.contains(other.end)
    fun isOverlapping(other: Range): Boolean = this.contains(other.start)
}
